...
/**
 * \file    test/functional/QRCodeFunctionalTest.php
 * \ingroup qrcode
 ...
 * @package Testqrcode
 */
class QRCodeFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	{
		$this->url('/custom/qrcode/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('qrcode/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/qrcode/admin/about.php');
		$this->authenticate();
		return $this->assertContains('qrcode/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('qrcodewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modQRCode_QRCodeTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modQRCode_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
