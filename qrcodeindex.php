...
/**
 *	\file       htdocs/qrcode/template/qrcodeindex.php
 *	\ingroup    qrcode
 *	\brief      Home page of qrcode top menu
 */
...
$langs->loadLangs(array("qrcode@qrcode"));

$action=GETPOST('action', 'alpha');


// Securite acces client
if (! $user->rights->qrcode->read) accessforbidden();
...
llxHeader("",$langs->trans("QRCodeArea"));

print load_fiche_titre($langs->trans("QRCodeArea"),'','qrcode.png@qrcode');
...
// Draft MyObject
if (! empty($conf->qrcode->enabled) && $user->rights->qrcode->read)
{
	$langs->load("orders");
