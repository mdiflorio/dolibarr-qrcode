...
/**
 * \file    modulebuilder/template/core/boxes/qrcodewidget1.php
 * \ingroup qrcode
 * \brief   Widget provided by QRCode
 *
 ...
 */
class qrcodewidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "qrcodebox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "qrcode@qrcode";
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		//$this->hidden = ! ($user->rights->qrcode->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//include_once DOL_DOCUMENT_ROOT . "/qrcode/class/qrcode.class.php";

		// Populate the head at runtime
		$text = $langs->trans("QRCodeBoxDescription", $max);
